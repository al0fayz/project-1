              ...
              <div class="box box-danger">
                ...
                <div class="box-body">
                  <div class="row">
                    <div class="col-md-3">
                      <p align="center">
					  <img src="{{ URL::asset('images/'.$info->foto ) }}" alt="gambar desa" height="100px" width="65px">
                        <a class="users-list-name" href="#">{{ $info->tanggal }}</a>
                        <span class="users-list-date">{{ $info->tentang }}</span>
                      </p>
                    </div><!-- /.col -->
                    <div class="col-md-8">
					...
					<div class="form-group">
						  ...
						  <a href="{{{ action('infocontroller@hapus',[$info->id]) }}}">
