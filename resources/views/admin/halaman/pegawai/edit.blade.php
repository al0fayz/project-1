            ...
            <div class="col-md-6">
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-body no-padding">
                      ...
                      <form id="menutambah" class="form-horizontal" role="form" method="POST" action="{{ url('/pegawai/'.$pegawai->id.'/update') }}">
                      ...
                      <div class="form-group {{ $errors->has('tempat_lahir') ? 'has-error' : '' }}">
                          ...
                          <div class="col-md-6 ">
                              <input type="type" class="form-control" name="tempat_lahir" value="{{ $pegawai->tempat_lahir }}">
					  ...
					  <div class="form-group {{ $errors->has('tanggal_lahir') ? 'has-error' : '' }}">
                          ...
                          <div class="col-md-6 ">
                              <input type="text" class="tanggal form-control " name='tanggal_lahir' value="{{ $pegawai->tanggal_lahir }}">
                      ...
                      <div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
                          ...
                          <div class="col-md-6 ">
                              <input type="type" class="form-control" name="email" value="{{ $pegawai->email }}">
					  ...
					  <div class="form-group {{ $errors->has('no_telp') ? 'has-error' : '' }}">
                          ...
                          <div class="col-md-6 ">
                              <input type="type" class="form-control" name="no_telp" value="{{ $pegawai->no_telp }}">
