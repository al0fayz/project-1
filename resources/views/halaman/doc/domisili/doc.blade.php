...
<section   class="tesimainal_aera">
                 <div class="container">
                    <div class="row">
                        <h1 class="news_title">Dokumen <span>  Domisili</span></h1> <!-- section title name -->
            ...
            <div class="col-md-12">
               ...
               <div class="box box-primary ">
                      <form id="menutambah" class="form-horizontal" role="form" method="POST" action="{{ url('/domisili') }}">
					  ...
					  <div class="form-group {{ $errors->has('alamat_domisili') ? 'has-error' : '' }}">
                          ...
                          <div class="col-md-6 ">
                              <input type="text" class="form-control" name="alamat_domisili" value="{{Request::old('alamat_domisili')}}" placeholder="Alamat Domisili">
