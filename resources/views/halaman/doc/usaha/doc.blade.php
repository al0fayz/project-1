...
<section   class="tesimainal_aera">
                 <div class="container">
                    <div class="row">
                        <h1 class="news_title">Dokumen <span>  Usaha</span></h1> <!-- section title name -->
            ...
            <div class="col-md-12">
               ...
               <div class="box box-primary ">
                      <form id="menutambah" class="form-horizontal" role="form" method="POST" action="{{ url('/usaha') }}">
					  ...
					  <div class="form-group {{ $errors->has('alamat_usaha') ? 'has-error' : '' }}">
                          ...
                          <div class="col-md-6 ">
                              <input type="text" class="form-control" name="alamat_usaha" value="{{Request::old('alamat_usaha')}}" placeholder="Alamat usaha Anda">
					  ...
					  <div class="form-group {{ $errors->has('klasifikasi') ? 'has-error' : '' }}">
                          ...
                          <div class="col-md-6 ">
                              <input type="type" class="form-control" name="klasifikasi" value="{{Request::old('klasifikasi')}}" placeholder="Klasifikasi / Jenis Usaha Anda">
							   <span class="text-danger">{{ $errors->first('klasifikasi') }}</span>
                          </div>
                      </div>
					  
					  <div class="form-group {{ $errors->has('tahun') ? 'has-error' : '' }}">
                          <label class="col-md-4 control-label">Tahun Berdiri</label>
                          <div class="col-md-6 ">
                              <input type="type" class="form-control" name="tahun" value="{{Request::old('tahun')}}" placeholder="Tahun Usaha Anda Berdiri">
